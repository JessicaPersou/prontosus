...
public interface FileAttachmentJpaRepository extends JpaRepository<FileAttachmentEntity, String> {
    ...
    List<FileAttachmentEntity> findByPatientId(@Param("patientId") String patientId);
    ...
    List<FileAttachmentEntity> findByPatientIdAndFileType(@Param("patientId") String patientId,
