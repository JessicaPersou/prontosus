...
public interface MedicalRecordJpaRepository extends JpaRepository<MedicalRecordEntity, Long> {
    ...
    List<MedicalRecordEntity> findByPatientIdOrderByConsultationDateDesc(@Param("patientId") Long patientId);
    ...
    List<MedicalRecordEntity> findByPatientAndDateRange(@Param("patientId") Long patientId,
